...
for( i in 1:length(all_signatures)){
  file = paste( "./TLS_project/results/signatures_TCGA/" , all_signatures[ i ] , "/Overall/OS/", all_signatures[ i ], "_COX_OS_hot_tumor.RData" , sep="" )
  print(file)
  if( file.exists( file ) ){
    load( file )
...
res = NULL
for( i in 1:length(all_signatures)){
  file = paste( "./TLS_project/results/signatures_TCGA/" , all_signatures[ i ] , "/Overall/PFI/", all_signatures[ i ], "_COX_PFI_hot_tumor.RData" , sep="" )
  if( file.exists( file ) ){
    load( file )
    res = rbind( res , c( meta_res , "sig" ) )
  }
...
pheatmap( t( data[ order( rowSums(data)) , ] ) , cluster_rows=FALSE , cluster_cols=FALSE , scale="none" , annotation_col = annotation_col, annotation_colors = ann_colors, 
          ...
          filename = "./TLS_project/results/summary_figures/heatmap/Heatmap_Summary_TCGA_hot_tumor.pdf", height=2.8, width=9.5 )  
...
pheatmap( t( data[ order( rowSums(data)) , ] ) , cluster_rows=FALSE , cluster_cols=FALSE , annotation_col = annotation_col, annotation_colors = ann_colors, 
          col = col , breaks = c( neg , pos ) , na_col="white" , border_color="#424242", angle_col = 315, fontfamily="serif" ,
          #display_numbers = data , number_color="black" , fontsize_number= 10 , 
          filename="./TLS_project/results/summary_figures/heatmap/Heatmap_Summary_legend_TCGA_hot_tumor.pdf", height=4, width=9.5 )  
...
res <- NULL
for( i in 1:length(all_signatures)){
  file = paste( "./TLS_project/results/signatures_TCGA/" , all_signatures[ i ] , "/Overall/OS/", all_signatures[ i ], "_COX_OS_cold_tumor.RData" , sep="" )
  if( file.exists( file ) ){
    load( file )
    res = rbind( res , c( meta_res , "sig" ) )
  }
...
res = NULL
for( i in 1:length(all_signatures)){
  file = paste( "./TLS_project/results/signatures_TCGA/" , all_signatures[ i ] , "/Overall/PFI/", all_signatures[ i ], "_COX_PFI_cold_tumor.RData" , sep="" )
  if( file.exists( file ) ){
    load( file )
    res = rbind( res , c( meta_res , "sig" ) )
  }
...
pheatmap( t( data[ order( rowSums(data)) , ] ) , cluster_rows=FALSE , cluster_cols=FALSE , scale="none" , annotation_col = annotation_col, annotation_colors = ann_colors, 
          col = col , breaks = c( neg , pos ) , na_col="white" , border_color="#424242", angle_col = 315, fontfamily="serif" ,
          #display_numbers = data , number_color="black" , fontsize_number= 10 , 
          filename = "./TLS_project/results/summary_figures/heatmap/Heatmap_Summary_TCGA_cold_tumor.pdf", height=2.8, width=9.5 )  

pheatmap( t( data[ order( rowSums(data)) , ] ) , cluster_rows=FALSE , cluster_cols=FALSE , annotation_col = annotation_col, annotation_colors = ann_colors, 
          col = col , breaks = c( neg , pos ) , na_col="white" , border_color="#424242", angle_col = 315, fontfamily="serif" ,
          #display_numbers = data , number_color="black" , fontsize_number= 10 , 
          filename="./TLS_project/results/summary_figures/heatmap/Heatmap_Summary_legend_TCGA_cold_tumor.pdf", height=4, width=9.5 )  