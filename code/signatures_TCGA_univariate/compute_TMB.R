...
for (i in 1:length(names(TCGA_pheno))){
    ...
    OS_KMplot_dir <- paste0("./TLS_project/results/signatures_TCGA_uni/", "TMB", "/KMPlot/OS/", names(TCGA_pheno)[i], ".pdf")
    PFI_KMplot_dir <- paste0("./TLS_project/results/signatures_TCGA_uni/", "TMB", "/KMPlot/PFI/", names(TCGA_pheno)[i], ".pdf")
...
save(cox_os, file = paste0("./TLS_project/results/signatures_TCGA_uni/", "TMB", "/COX_OS.Rdata"))
save(cox_pfi, file = paste0("./TLS_project/results/signatures_TCGA_uni/", "TMB", "/COX_PFI.Rdata"))
